  ...
  return (
    <div className="page">
      <div className="page__container">
        ...
        />
        <Footer />
        <PopupWithForm isOpen={isEditProfilePopupOpen} onClose={closeAllPopups} name='profile-form' title='Редактировать профиль' buttonText='Сохранить'>
        ...
        <PopupWithForm isOpen={isAddPlacePopupOpen} onClose={closeAllPopups} name='photo-form' title='Новое место' buttonText='Создать'>
        ...
        <PopupWithForm isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups} name='change-ava' title='Обновить аватар' buttonText='Сохранить'>
